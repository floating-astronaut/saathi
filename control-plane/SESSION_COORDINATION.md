...
|-------|-----|---------|------|----------------------|--------|
| Clawcore | dev `ip-172-31-41-224` | 2026-07-29T20:53Z | RUNTIME-MIGRATION-2 | `ops/saathi-web.service`, `ops/saathi-worker.service`, `ops/cloudflared/`, `docs/RUNBOOK.md`, `docs/ARCHITECTURE.md`, `docs/PROD_READINESS.md`, `CHANGELOG.md`, control-plane/session write-back | **active** — Phase 2: systemd units + cloudflared + live cutover |
