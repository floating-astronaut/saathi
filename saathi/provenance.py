...
def fence(text: str, prov: Provenance) -> str:
    ...
    return (
        ...
        "Give a daily-life answer: say what it means, flag scam or pressure signs, "
        "pull out any amount/date/place/person/action needed, and end with exactly "
        "one safe next step. If it asks for money, an OTP, a PIN, bank details, "
        ...
        "ask the user to say that request themselves if they want it.\n"
