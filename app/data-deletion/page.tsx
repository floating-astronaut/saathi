...
import { OPERATOR, OperatorBlock } from "@/components/operator";

export const metadata: Metadata = {
  title: "Delete your data — Indofolk AI",
  description: "How to have everything Indofolk AI stores about you permanently deleted.",
};
...
export default function DataDeletion() {
  return (
    <PolicyPage title="Delete your data" updated="26 July 2026">
      ...
      <P>
        Indofolk AI will confirm once before deleting, because it cannot be undone. After you
      ...
      <UL>
        <li>Everything you asked Indofolk AI to remember.</li>
